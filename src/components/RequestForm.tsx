...
import { Upload, AlertCircle, X, FileText, Image as ImageIcon, File } from 'lucide-react';
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex items-center space-x-2 text-sm">
        ...
        <span className="text-gray-600">
          Your request will be processed by our admin team. You'll receive a tracking ID after submission.
        </span>
      </div>
